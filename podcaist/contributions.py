...
if __name__ == "__main__":
    possible_models = ["gpt-4o-mini-2024-07-18", "o3-2025-04-16", "o3-mini-2025-01-31", "gpt-4.1-2025-04-14", "gemini-2.5-pro-preview-06-05"]
    model_name = possible_models[4]

    pdf_name = "Learning Physically Simulated Tennis Skills from Broadcast Videos.pdf"
    pdf_path = "/Users/derek/Library/Mobile Documents/com~apple~CloudDocs/Desktop/ML Papers 2/papers_to_read/" + pdf_name
    ...
    response = asyncio.run(summarize_contributions_async(compressed_pdf_path, model_name))
